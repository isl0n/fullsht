...
public:
    ...
    void setAnalogValue(float value) {
        // устанавливает аналоговое значение устройства
        // value - значение аналогового сигнала в диапазоне от 0 до 1
    }

    float getAnalogValue() const {
        // возвращает текущее аналоговое значение устройства
    ...
    bool isOn() const {
        // возвращает состояние устройства (вкл. или выкл.)
        return m_isOn;
    }
